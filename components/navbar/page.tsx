...
const NAV_ITEMS: NavItem[] = [
  ...
  links: [
    { label: "Primaire microporeux", href: "/peintures/primaire-microporeux" },
    { label: "Lasure protectrice", href: "/peintures/lasure-protectrice" },
    { label: "Vernis intérieur", href: "/peintures/vernis-interieur" },
    { label: "Saturateur terrasse", href: "/peintures/saturateur-terrasse" },
    { label: "Laque mate", href: "/peintures/laque-mate" },
    { label: "Laque satinée", href: "/peintures/laque-satinee" },
    { label: "Laque brillante", href: "/peintures/laque-brillante" },
    { label: "Sous-couche laque", href: "/peintures/sous-couche-laque" },
  ],
},
      {
        ...
        links: [
          { label: "finition mate", href: "/peintures/products-finition-mate" },
          { label: "finition satinee", href: "/peintures/products-finition-satinee" },
          { label: "finition veloutee", href: "/peintures/products-finition-veloutee" },
          { label: "impression-sous couche", href: "/peintures/products-impression-sous-couche" },
      ...
      },
      {
        ...
        image: "/exterieur.png",
        links: [
          { label: "Primaire facade", href: "/peintures/products-primaire-facade" },
          { label: "Revetement bas carbone", href: "/peintures/products-revetement-bas-carbone" },
          { label: "Finition-tous-temps", href: "/peintures/products-finition-tous-temps" },
          { label: "Anti mousse et traitement", href: "/peintures/products-anti-mousse-et-traitement" },
